...
public class EffectsUI : MonoBehaviour
{
    ...
    public void SpawnEffect(EffectSO effect, GameObject parant)
    {
        ...
        temp.GetComponentInChildren<TMP_Text>().text = effect.effectName;
        curEffects.Add(temp);
    }

    public void RemoveEffect(EffectSO effect)
    {
        GameObject temp = curEffects.FindLast(e => e.GetComponentInChildren<TMP_Text>().text == effect.effectName);   
